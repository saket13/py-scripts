...
def link_generate(name_question,list_links):
	for name_question in name_question:
		if name_question == '':
			...
			quote_page = "http://www.spoj.com/status/%s,anudeep2011/"%(name_question) #Replace it with your user name
...
quote_page = "http://www.spoj.com/users/anudeep2011/" #Replace it with your user name
